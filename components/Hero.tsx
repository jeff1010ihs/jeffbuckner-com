    ...
    <header className="relative pt-20 pb-16 md:pt-24 md:pb-24 overflow-hidden border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-6xl">
          <div className="flex sm:inline-flex items-center justify-center sm:justify-start space-x-2 bg-slate-100 px-3 py-1 mt-6 mb-6">
          ...
          <p className="text-base md:text-xl text-slate-700 leading-relaxed max-w-[59rem] mb-8 font-light">
            <span className="font-black">You can experience the joy, peace, and purpose of a life set apart for God.</span> From the sanctity of your family to the challenges of your work and your role in the community, we will align every area of your life with the heart of Jesus and obedience to biblical truth. I help men grow in their Christian faith through coaching and programs for individuals, men's ministries, and businesses.
          </p>
