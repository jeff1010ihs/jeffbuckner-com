      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-slate-500 font-serif italic text-xl leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {colors.map((color) => (
              <div key={color.name} className="group">
                ...
                <p className="text-[10px] text-slate-500 leading-tight pr-4">{color.use}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="text-right">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed max-w-sm ml-auto mt-4">
